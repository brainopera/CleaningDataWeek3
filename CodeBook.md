...
Feature Selection 
-----------------
Referencing the README and features.txt files in the original dataset, you can learn more about the feature selection for this dataset. And there you will find the follow description:
